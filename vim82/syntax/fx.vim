" Vim syntax file
" Language:	HLSL FX
" Maintainer:	shooker2012 <lovelywzz@gmail.com>
" Last change:	$Date: 2014/08/16 $
...
syn keyword fxStatement		AppendStructuredBuffer ConsumeStructuredBuffer asm_fragment BlendState Buffer ByteAddressBuffer
syn keyword fxStatement		cbuffer 
syn keyword fxStructure		class interface
...
syn keyword fxType		float1 float2 float3 float4
...
" texture types
syn keyword fxType		sampler sampler1D sampler2D sampler3D samplerCUBE
" syn keyword fxType		samplerRECT
" compile-time special types
" syn keyword fxType		cint cfloat
syn keyword fxType		matrix dword min10float min16int min12int min16uint
syn keyword fxType		RWBuffer RWByteAddressBuffer RWStructuredBuffer RWTexture1D RWTexture1DArray RWTexture2D RWTexture2DArray RWTexture3D
syn keyword fxType		uint vector vertexfragment
...
" fx
syn keyword fxStatement		compile asm compile_fragment
syn keyword fxType		string texture technique pass
syn keyword fxType		technique10 technique11
syn keyword fxType		Texture1D Texture1DArray Texture2D Texture2DArray Texture2DMS Texture2DMSArray Texture3D TextureCube TextureCubeArray
syn keyword fxType		point line triangle lineadj triangleadj
...
syn keyword fxStorageClass	shared precise groupshared row_major column_major
syn keyword fxStorageClass	linear centroid nointerpolation noperspective sample
syn keyword fxStorageClass	export snorm unorm
...
if version >= 508 || !exists("did_fx_syntax_inits")
  ...
  HiLink fxProfile		Statement
  HiLink fxSamplerArg		Statement
  HiLink fxStatement		Statement
  HiLink fxType			Type
  HiLink fxStorageClass		StorageClass
  HiLink fxSemantic		Structure
  HiLink fxNumber		Number
  HiLink fxStructure		Structure
