...
syn keyword        glslType                sampler1D sampler2D sampler3D samplerCUBE sampler1DShadow sampler2DShadow samplerCube samplerCubeShadow
...
syn keyword        glslUniform             sampler1DArray sampler2DArray
syn keyword        glslUniform             sampler1DArrayShadow sampler2DArrayShadow
syn keyword        glslUniform             isampler1D isampler2D isampler3D isamplerCube
syn keyword        glslUniform             isampler1DArray isampler2DArray
syn keyword        glslUniform             usampler1D usampler2D usampler3D usamplerCube
syn keyword        glslUniform             usampler1DArray usampler2DArray
syn keyword        glslUniform             sampler2DRect sampler2DRectShadow isampler2DRect usampler2DRect
syn keyword        glslUniform             samplerBuffer isamplerBuffer usamplerBuffer
syn keyword        glslUniform             sampler2DMS isampler2DMS usampler2DMS
syn keyword        glslUniform             sampler2DMSArray isampler2DMSArray usampler2DMSArray
syn keyword        glslUniform             samplerCubeArray samplerCubeArrayShadow isamplerCubeArray usamplerCubeArray
syn keyword        glslUniform             uint uvec2 uvec3 uvec4
...
syn keyword        glslStatement         asm
syn keyword        glslStatement         class union enum typedef template this packed
syn keyword        glslStatement         goto switch default
syn keyword        glslStatement         inline noinline volatile public static extern external interface
syn keyword        glslType         long short double half fixed unsigned
syn keyword        glslStatement         input output
syn keyword        glslType         hvec2 hvec3 hvec4 dvec2 dvec3 dvec4 fvec2 fvec3 fvec4 
syn keyword        glslType         sampler2DRect sampler3DRect sampler2DRectShadow
syn keyword        glslStatement         sizeof cast
syn keyword        glslStatement         namespace using
syn keyword        glslStatement         layout sample centroid flat smooth noperspective patch subroutine lowp mediump highp precision
syn keyword        glslStatement         row_major case invariant
